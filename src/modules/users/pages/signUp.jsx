...
<div class="signup-form">
    <form action="/examples/actions/confirmation.php" method="post" class="form-horizontal">
        ...
        <div class="form-group row">
			<label class="col-form-label col-4">Institute Name</label>
			<div class="col-8">
                <input type="text" class="form-control" name="institute ame" required="required">
            </div>        	
        </div>
        <div class="form-group row">
			<label class="col-form-label col-4">Degree Program</label>
			<div class="col-8">
                <input type="text" class="form-control" name="degree program" required="required">
            </div>        	
        </div>
        <div class="form-group row">
			<label class="col-form-label col-4">DOB</label>
			<div class="col-8">
                <input type="number" class="form-control" name="dateofbirth" required="required">
            </div>        	
        </div>
        <div class="form-group row">
